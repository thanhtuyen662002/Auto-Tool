    ...
    <GlassCard className="grid gap-4 p-5" strong>
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          <h2 className="font-semibold text-white">Chọn preset</h2>
      ...
      {recommendedPreset ? (
        <div className="rounded-md border border-emerald-300/20 bg-emerald-300/10 p-3 text-sm leading-6 text-emerald-100">
          <span className="font-semibold">Gợi ý cho bạn: {recommendedPreset.name}.</span> {recommendationReason || 'Preset này phù hợp nhất với workflow hiện tại.'}
        </div>
      ) : null}
