...
const filters: Array<{ value: SubtitleLineFilter; label: string }> = [{ value: 'all', label: 'Tất cả' }, { value: 'needs_review', label: 'Cần kiểm tra' }, { value: 'critical', label: 'Lỗi nặng' }, { value: 'edited', label: 'Đã sửa' }, { value: 'unedited', label: 'Chưa sửa' }, { value: 'ocr', label: 'Đọc chữ' }, { value: 'asr', label: 'Nghe thoại' }, { value: 'visual', label: 'Từ cảnh' }];
