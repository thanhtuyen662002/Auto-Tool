...
export const DEFAULT_REVIEW_RENDER_SETTINGS: DouyinReupSettings = {
  ...
  subtitle_source_priority: ['sidecar_srt', 'embedded_subtitle', 'ocr_hardsub', 'asr'], use_sidecar_srt: true,
  ...
  subtitle_quality_gate_enabled: true, asr_quality_min_blocks: 3, asr_quality_min_chars: 24,
  ocr_quality_min_blocks: 2, ocr_quality_min_chars: 16, subtitle_quality_min_coverage: 0.18,
  ...
  silent_segment_duration_min: 1.2, silent_segment_duration_max: 4, generate_visual_captions: false,
  silent_visual_caption_min_product_confidence: 0.75, silent_visual_caption_min_segments: 3,
