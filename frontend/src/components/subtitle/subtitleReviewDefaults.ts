...
export const DEFAULT_REVIEW_RENDER_SETTINGS: DouyinReupSettings = {
  ...
  ocr_manual_region: null, ocr_min_confidence: 0.55, ocr_dedupe_similarity: 0.86,
  ...
  add_overlay: true, keep_original_audio: true, add_bgm: true, music_folder: '', favorite_music_paths: [], bgm_volume: 0.16,
