...
const VIETNAMESE_SUBTITLE_STYLE_PRESETS: VietnameseSubtitleStylePreset[] = [
  {
    id: 'review_clean',
    name: 'Review Clean',
    description: 'Xanh mint hiện đại, hợp review sản phẩm đời sống và video nói chuyện.',
    accentColor: '#5EEAD4',
    previewText: 'Review cực tốt',
    settings: {
      subtitle_style_custom_enabled: true,
      subtitle_font_family: 'Be Vietnam Pro',
      subtitle_font_size: 56,
      subtitle_font_color: '#F8FAFC',
      subtitle_stroke_color: '#020617',
      subtitle_stroke_width: 2,
      subtitle_shadow_enabled: true,
      subtitle_shadow_color: '#000000',
      subtitle_shadow_opacity: 0.72,
      subtitle_shadow_size: 5,
      subtitle_max_chars_per_line: 24,
      subtitle_max_lines: 2,
      subtitle_cover_enabled: true,
      subtitle_cover_color: '#0F172A',
      subtitle_cover_opacity: 0.84,
      subtitle_cover_height_ratio: 0.12,
      subtitle_cover_padding_ratio: 0.035,
  ...
  },
  {
    id: 'review_yellow',
    name: 'Review Yellow',
    description: 'Chữ trắng viền chắc, nhấn vàng nổi bật cho ưu điểm và thông số sản phẩm.',
    accentColor: '#FACC15',
    previewText: 'Pin gần 8 tiếng',
    settings: {
      subtitle_style_custom_enabled: true,
      subtitle_font_family: 'Montserrat',
      subtitle_font_size: 56,
      subtitle_font_color: '#FFFFFF',
      subtitle_stroke_color: '#09090B',
      subtitle_stroke_width: 2,
      subtitle_shadow_enabled: true,
      subtitle_shadow_color: '#000000',
      subtitle_shadow_opacity: 0.72,
  ...
  },
  {
    id: 'sale_orange',
    name: 'Sale Orange',
    description: 'Cam nổi bật, chữ gọn và đậm, phù hợp giá sốc, ưu đãi và CTA.',
    accentColor: '#FB923C',
    previewText: 'Chốt đơn ngay',
    settings: {
      subtitle_style_custom_enabled: true,
      ...
      subtitle_font_color: '#FFF7ED',
      subtitle_stroke_color: '#1C0A00',
      subtitle_stroke_width: 2,
      subtitle_shadow_enabled: true,
      subtitle_shadow_color: '#000000',
      subtitle_shadow_opacity: 0.72,
  ...
  },
  {
    id: 'beauty_pink',
    name: 'Beauty Pink',
    description: 'Tím hồng mềm mại cho mỹ phẩm, thời trang, lifestyle và làm đẹp.',
    accentColor: '#F0ABFC',
    previewText: 'Xinh nhẹ nhàng',
    settings: {
      subtitle_style_custom_enabled: true,
      ...
      subtitle_font_size: 56,
      subtitle_font_color: '#FFF7FD',
      subtitle_stroke_color: '#180718',
      subtitle_stroke_width: 2,
      subtitle_shadow_enabled: true,
      subtitle_shadow_color: '#000000',
  ...
  },
  {
    id: 'tech_cyan',
    name: 'Tech Cyan',
    description: 'Xanh cyan lạnh và hiện đại, hợp điện thoại, máy tính, gadget và công nghệ.',
    accentColor: '#22D3EE',
    previewText: 'Nét căng luôn',
    settings: {
      subtitle_style_custom_enabled: true,
      ...
      subtitle_font_size: 54,
      subtitle_font_color: '#ECFEFF',
      subtitle_stroke_color: '#020B12',
      subtitle_stroke_width: 2,
      subtitle_shadow_enabled: true,
      subtitle_shadow_color: '#000000',
      subtitle_shadow_opacity: 0.72,
  ...
  },
  {
    id: 'kitchen_green',
    name: 'Kitchen Green',
    description: 'Xanh lá dịu, hợp gia dụng, đồ bếp, mẹ và bé hoặc thực phẩm.',
    accentColor: '#A3E635',
    previewText: 'Dùng tiện lắm',
    settings: {
      subtitle_style_custom_enabled: true,
      ...
      subtitle_font_size: 56,
      subtitle_font_color: '#F7FEE7',
      subtitle_stroke_color: '#071108',
      subtitle_stroke_width: 2,
      subtitle_shadow_enabled: true,
      subtitle_shadow_color: '#000000',
      subtitle_shadow_opacity: 0.66,
      subtitle_shadow_size: 5,
      subtitle_max_chars_per_line: 24,
      subtitle_max_lines: 2,
      subtitle_cover_enabled: true,
      subtitle_cover_color: '#17231A',
      subtitle_cover_opacity: 0.9,
      subtitle_cover_height_ratio: 0.12,
      subtitle_cover_padding_ratio: 0.035,
  ...
  },
  {
    id: 'story_peach',
    name: 'Story Peach',
    description: 'Hồng đào nhẹ nhàng, hợp kể chuyện, daily review và trải nghiệm cá nhân.',
    accentColor: '#FB7185',
    previewText: 'Nhìn thích ghê',
    settings: {
      subtitle_style_custom_enabled: true,
      ...
      subtitle_font_color: '#FFF1F2',
      subtitle_stroke_color: '#1F0710',
      subtitle_stroke_width: 2,
      subtitle_shadow_enabled: true,
      subtitle_shadow_color: '#000000',
      subtitle_shadow_opacity: 0.68,
      subtitle_shadow_size: 5,
      subtitle_max_chars_per_line: 24,
      subtitle_max_lines: 2,
      subtitle_cover_enabled: true,
      subtitle_cover_color: '#3B1724',
      subtitle_cover_opacity: 0.88,
      subtitle_cover_height_ratio: 0.12,
      subtitle_cover_padding_ratio: 0.035,
      subtitle_cover_radius_ratio: 0.04,
  ...
  },
  {
    id: 'white_minimal',
    name: 'White Minimal',
    description: 'Khung trắng chữ tối, hợp video review tối giản, chuyên nghiệp và cao cấp.',
    accentColor: '#E11D48',
